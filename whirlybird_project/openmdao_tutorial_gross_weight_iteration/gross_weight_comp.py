...
class GrossWeightComp(ExplicitComponent):
    ...
    def compute(self, inputs, outputs):
        ...
        outputs['W0'] = (Wp + Wc) / (1 - We_W0 - Wb_W0) # added the Wb_W0 term
    ...
    def compute_partials(self, inputs, partials):
        ...
        We_W0 = inputs['We/W0']
        Wb_W0 = inputs['Wb/W0']
        partials['W0', 'Wp'] = 1. / (1 - We_W0 - Wb_W0)
        partials['W0', 'Wc'] = 1. / (1 - We_W0 - Wb_W0)
        partials['W0', 'We/W0'] = (Wp + Wc) / (1 - We_W0 - Wb_W0) ** 2
        partials['W0', 'Wb/W0'] = (Wp + Wc) / ( 1 - We_W0 - Wb_W0)** 2